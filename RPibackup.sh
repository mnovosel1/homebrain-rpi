...
scp /srv/PiStorage/backups/hbrain_node-red_$date.tgz hbrain@10.10.10.100:/srv/storage/2_backups/RPi_hbrain_backup/hbrain_node-red/

echo "Backup /etc to hbrain_etc_$date.tgz...."
tar -zcf /srv/PiStorage/backups/hbrain_DIR-etc_$date.tgz /etc/
scp /srv/PiStorage/backups/hbrain_DIR-etc_$date.tgz hbrain@10.10.10.100:/srv/storage/2_backups/RPi_hbrain_backup/hbrain_etc/
...
scp /srv/PiStorage/backups/hbrain_DIR-hbraindir_$date.tgz hbrain@10.10.10.100:/srv/storage/2_backups/RPi_hbrain_backup/hbrain_HomeBrain/
